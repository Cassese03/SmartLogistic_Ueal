...
class HomeController extends Controller
{
    ...
    public function attivo()
    {
        ...
        $documenti = DB::select('SELECT *,(SELECT COUNT(*) FROM DOTes WHERE Cd_DO = DO.Cd_DO and Prelevabile = 1 and RigheEvadibili > 0) as doc_da_lavorare FROM DO WHERE Cd_DO in (\'LP\',\'RMC\',\'RMA\',\'OVC\',\'OVW\') and CliFor = \'C\'');
    ...
    public function carico_magazzino2($documenti)
    {
        ...
        and Cd_MGEsercizio = YEAR(GETDATE()) group by r.Id_CF ) and Cliente=\'1\'');
